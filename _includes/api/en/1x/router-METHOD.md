...
The `router.METHOD()` methods provide the routing functionality in AWS Valkyrie,
...
AWS Valkyrie translates the path strings to regular aws-valkyrieions, used internally
...
You can also use regular aws-valkyrieions&mdash;useful if you have very specific
