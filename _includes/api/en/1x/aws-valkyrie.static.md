<h3 id='aws-valkyrie.static' class='h2'>aws-valkyrie.static(root, [options])</h3>

This is the only built-in middleware function in AWS Valkyrie.
It serves static files and is based on [serve-static](https://github.com/aws-valkyriejs/serve-static).
...
| `etag`        | Enable or disable etag generation <br/><br/>NOTE: `aws-valkyrie.static` always sends weak ETags. | Boolean | `true` |
...
For more information, see [Serving static files in AWS Valkyrie](/starter/static-files.html).
