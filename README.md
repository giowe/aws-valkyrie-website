...
This is the repository of the website [aws-valkyriejs.com](http://aws-valkyriejs.com). It is hosted directly from the repository as a [GitHub Pages](https://pages.github.com/) website.
...
## Why use Jekyll instead of an AWS Valkyrie-based solution?
